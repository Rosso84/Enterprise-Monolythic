...
class HumorControllerTest {

    @LocalServerPort
    protected var port = 0

    @Autowired
    protected lateinit var humorRepository: HumorRepository
    ...
    fun testCreateAndGetByID() {
        ...
        val location = RestAssured.given().contentType(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .body(HumorDto(type, level, "some notes", time, calendarId))
                .post("calendars/$calendarId/humors")
                .then()
                .statusCode(201)
                .extract().header("location")
        ...
        RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .get("calendars/$calendarId/humors/$id")
                .then()
                .statusCode(200)
    ...
    fun testGetAll() {
        ...
        val createFirst = RestAssured.given().contentType(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .body(HumorDto(type1, level1, "some notes", time, calendarId))
                .post("calendars/$calendarId/humors")
                .then()
                .statusCode(201)
                .extract().header("location")
        ...
        RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .get("calendars/$calendarId/humors/$id1")
                .then()
                .statusCode(200)
        ...
        val createdSecond = RestAssured.given().contentType(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .body(HumorDto(type2, level2, "some notes", time, calendarId))
                .post("calendars/$calendarId/humors")
                .then()
                .statusCode(201)
                .extract().header("location")
        ...
        RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .get("calendars/$calendarId/humors/$id2")
                .then()
                .statusCode(200)
        ...
        val createdThird = RestAssured.given().contentType(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .body(HumorDto(type3, level3, "some notes", time, calendarId))
                .post("calendars/$calendarId/humors")
                .then()
                .statusCode(201)
                .extract().header("location")
        ...
        RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .get("calendars/$calendarId/humors/$id3")
                .then()
                .statusCode(200)
        ...
        val numberOfRegistered = RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .get("calendars/$calendarId/humors")
                .then()
                .statusCode(200)
    ...
    fun testDeleteById() {
        ...
        RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .delete("calendars/$calendarId/humors/$id")
                .then()
                .statusCode(204)
