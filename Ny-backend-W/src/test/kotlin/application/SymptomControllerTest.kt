...
class SymptomControllerTest {
    ...
    fun testCreateAndGetByID() {
        ...
        val location = RestAssured.given().contentType(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .body(SymptomDto(type, level, "some notes", time, calendarId))
                .post("calendars/$calendarId/symptoms")
                .then()
                .statusCode(201)
                .extract().header("location")
        ...
        RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .get("calendars/$calendarId/symptoms/$id")
                .then()
                .statusCode(200)
                .body("data.type", CoreMatchers.equalTo(type))
    }

    /**@Updates a existing symptom registered*/
    @Test
    fun testUpdate() {
        val idList = createDefaultParentAndReturnIds()
        ...
        val newType = "Cough"
        val newLevel = Level.MODERATE
        val newNotes = "som other notes"

        //update with new and should return 204
        RestAssured.given().contentType(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .body(SymptomDto(newType, newLevel, newNotes, time, calendarId))
                .put("calendars/$calendarId/symptoms/$id")
                .then()
                .statusCode(204)
    }
    ...
    fun testGetAll() {
        ...
        val createFirst = RestAssured.given().contentType(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .body(SymptomDto(type1, level1, "some notes", time, calendarId))
                .post("calendars/$calendarId/symptoms")
                .then()
                .statusCode(201)
                .extract().header("location")
        ...
        RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .get("calendars/$calendarId/symptoms/$id1")
                .then()
                .statusCode(200)
        ...
        val createdSecond = RestAssured.given().contentType(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .body(SymptomDto(type2, level2, "some notes", time, calendarId))
                .post("calendars/$calendarId/symptoms")
                .then()
                .statusCode(201)
                .extract().header("location")
        ...
        RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .get("calendars/$calendarId/symptoms/$id2")
                .then()
                .statusCode(200)
        ...
        val createdThird = RestAssured.given().contentType(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .body(SymptomDto(type3, level3, "some notes", time, calendarId))
                .post("calendars/$calendarId/symptoms")
                .then()
                .statusCode(201)
                .extract().header("location")
        ...
        RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .get("calendars/$calendarId/symptoms/$id3")
                .then()
                .statusCode(200)
        ...
        val numberOfRegistered = RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .get("calendars/$calendarId/symptoms")
                .then()
                .statusCode(200)
    ...
    fun testDeleteById() {
        ...
        RestAssured.given().accept(ContentType.JSON)
                .cookie("JSESSIONID", cookie)
                .delete("calendars/$calendarId/symptoms/$id")
                .then()
                .statusCode(204)
